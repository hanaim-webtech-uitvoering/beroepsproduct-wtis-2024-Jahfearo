...
<body>
    <div class="wrapper">
        ...
        <nav> 
            <ul>
                <li><a href="detailoverzichtBestelling.html">Detailoverzicht Bestelling</a></li>
                <li><a href="BestellingoverzichtPersoneel.html">Bestellingoverzicht Personeel</a></li>
            </ul>
        </nav>
        ...
        <div class="content"> 
            <h1>Uw Werk Profiel</h1>
            <div class="grid-container">
                <section>
                    <h2> Uw Inlog Gegevens</h2>
                    <p> 
                        email: uw email
                        <br>
                        Wachtwoord: uw Wachtwoord
                        <br>
                        persooneelsid: uw persooneelsid
                    </p>
                </section>
            </div>
        </div>        
