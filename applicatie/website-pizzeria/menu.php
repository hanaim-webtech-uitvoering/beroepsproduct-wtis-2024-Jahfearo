                ...
                <div class="menu">
                    ...
                    <div class="menu-item">
                        <div class="menu-content">
                            <h2>Coca-Cola 330ml <span class="info">ℹ️</span></h2>
                            <p class="price">€ 2,80</p>
                            <p class="details">incl. statiegeld (€ 0,15), Bevat cafeïne (10,00 mg/100 ml)</p>
                        </div>
                    ...
                    <div class="menu-item">
                        <div class="menu-content">
                            <h2>Pizza Margherita <span class="info">ℹ️</span></h2>
                            <p class="price">€ 9,90</p>
                            <p class="details">Tomatensaus en kaas</p>
                        </div>
                        <img src="img/pizzamagerita.jpg" alt="pizza Margherita">
                        <input type="number" class="quantity-input" min="1" value="1">
                        <button class="add-button">+</button>
                        ...
                        <div class="menu-item">
                            <div class="menu-content">
                                <h2>Pizza Salami <span class="info">ℹ️</span></h2>
                                <p class="price">€ 11</p>
                                <p class="details">Tomatensaus,kaas,salami</p>
                            </div>
